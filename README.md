...
🔭 I'm currently developing personal projects and advancing my technical skills in backend and frontend areas<br>
🌱 Learning: React Native, Next.js, Prisma, Docker<br>
👯 Looking to collaborate on: Open source projects, team-based applications and API integrations<br>
...
![REST API](https://img.shields.io/badge/REST-00599C?logo=swagger&logoColor=white)
![WebSocket](https://img.shields.io/badge/WebSocket-FFA500?logo=websocket&logoColor=white)
...
<div align="center">
  <table>
    <tr>
      ...
      <!-- Alt galeri -->
      <a href="https://github.com/GoktugGok/FocusFlow">
        <img src="https://github.com/GoktugGok/FocusFlow/blob/main/screenshot/main.png" width="45%" style="margin:5px; border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.15); border:1px solid #ccc;" alt="Jewelry Product"/>
      </a>
      <a href="https://github.com/GoktugGok/jewelry-e-commerce">
        <img src="https://github.com/GoktugGok/FocusFlow/blob/main/screenshot/login.png" width="45%" style="margin:5px; border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.15); border:1px solid #ccc;" alt="Jewelry Product"/>
      </a>
    </td>
    </tr>
  </table>
